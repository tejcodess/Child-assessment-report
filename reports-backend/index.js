...
const buildReplacements = (body) => {
  ...
  return {
    ...
    // Req #5C: NIMHANS section toggle — "block" shows the page, "none" hides it entirely
    "«NIMHANS_Result»": normalize(body.nimhansResult) || "",
    "«NIMHANS_Display»": normalize(body.nimhansResult) ? "block" : "none",
